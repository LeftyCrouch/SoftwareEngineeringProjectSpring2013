    ...
    <div id="wrapper">
      <div id="content">
        ...
        <div id='top_menu'>
          <div id='top_options'>
            <ul>
			  <li><a href='addQuestions.php'>Add a Question</a> | </li>
		...
		<div class="questions container-fluid Container">	
		  ...
		  <?php
		    //edit a case
			echo'<form class="form-signin-case" name="editQuestions" method="post" action="editQuestion.php" enctype="multipart/form-data">
                   <h2 class="form-signin-heading">Edit Question</h2>
		           <h4> Fill in all fields</h4>
				   <input type="hidden" name="GFID" value="'.$_GET['GFID'].'">
 		           <input type="text" name="question" class="input-block-level" placeholder="Question" value="'.htmlentities($_GET['question']).'">
                   <textarea name="answer" class="input-block-level" placeholder="Answer">'.urldecode($_GET['answer']).'</textarea>
